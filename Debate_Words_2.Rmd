...
# 1314     people    33      85      10      10 138
# 1567    sanders     0     119       0       0 119
# 747       going    44      44      10      10 108
# 399     country    34      70       1       1 106
# 680     fiorina     0       0      46      46  92
# 756  government     0       7      40      40  87

```

```{r, echo=FALSE, fig.align="center", fig.height= 5, fig.width=4, message=FALSE, warning=FALSE}
...
p <- ggplot(mc[mc$all>40,], aes(x = rank, size=3))
...
p <- p + theme(axis.text.x=element_text(angle=90, vjust=1, face="italic", color="#222222"), axis.text.y=element_text(face="italic", color="#222222"),legend.title=element_blank())
#p <- p + coord_flip()
...
key_words = c("tax", "government", "climate", "class", "wall", "terror", "economy", "immigrant", "america", "veteran", "drug", "health", "gun", "educat")
